...
#define HCR_APK			(1UL << 40U)
#define HCR_API			(1UL << 41U)
#define HCR_ATA			(1UL << 56U)
...
#define ID_AA64PFR1_MTE_SHIFT		8U
#define ID_AA64PFR1_MTE_MASK		(0xfUL << ID_AA64PFR1_MTE_SHIFT)
#define ID_AA64PFR1_MTE_MTE2		2UL
#define ID_AA64PFR1_BT_SHIFT		0U
#define ID_AA64PFR1_BT_MASK		(0xfUL << ID_AA64PFR1_BT_SHIFT)
#define ID_AA64PFR1_MTE_FRAC_SHIFT	40U
#define ID_AA64PFR1_MTE_FRAC_MASK	(0xfUL << ID_AA64PFR1_MTE_FRAC_SHIFT)
#define ID_AA64PFR1_MTEX_SHIFT		52U
#define ID_AA64PFR1_MTEX_MASK		(0xfUL << ID_AA64PFR1_MTEX_SHIFT)

#define ID_AA64ISAR0_RNDR_SHIFT	60U
#define ID_AA64ISAR0_RNDR_MASK		(0xfUL << ID_AA64ISAR0_RNDR_SHIFT)

#define ID_AA64ISAR1_APA_SHIFT		4U
#define ID_AA64ISAR1_APA_MASK		(0xfUL << ID_AA64ISAR1_APA_SHIFT)
#define ID_AA64ISAR1_API_SHIFT		8U
#define ID_AA64ISAR1_API_MASK		(0xfUL << ID_AA64ISAR1_API_SHIFT)
#define ID_AA64ISAR1_ADDR_PAUTH_MASK	(ID_AA64ISAR1_APA_MASK | \
	ID_AA64ISAR1_API_MASK)
#define ID_AA64ISAR1_GPA_SHIFT		24U
#define ID_AA64ISAR1_GPA_MASK		(0xfUL << ID_AA64ISAR1_GPA_SHIFT)
#define ID_AA64ISAR1_GPI_SHIFT		28U
#define ID_AA64ISAR1_GPI_MASK		(0xfUL << ID_AA64ISAR1_GPI_SHIFT)
#define ID_AA64ISAR1_PAUTH_MASK	(ID_AA64ISAR1_APA_MASK | \
	ID_AA64ISAR1_API_MASK | ID_AA64ISAR1_GPA_MASK | \
	ID_AA64ISAR1_GPI_MASK)

#define ID_AA64ISAR2_APA3_SHIFT	12U
#define ID_AA64ISAR2_APA3_MASK		(0xfUL << ID_AA64ISAR2_APA3_SHIFT)
