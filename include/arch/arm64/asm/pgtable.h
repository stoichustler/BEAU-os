...
#define PAGE_S2_MEMATTR_DEVICE_nGnRnE	(0x0UL << 2U)
#define PAGE_S2_MEMATTR_DEVICE_nGnRE	(0x1UL << 2U)
#define PAGE_S2_MEMATTR_DEVICE_nGRE	(0x2UL << 2U)
#define PAGE_S2_MEMATTR_DEVICE_GRE	(0x3UL << 2U)
#define PAGE_S2_MEMATTR_DEVICE		PAGE_S2_MEMATTR_DEVICE_nGnRE
...
enum arm64_memory_type {
	...
	ARM64_MEMORY_UNMAPPED,
	ARM64_MEMORY_NORMAL,
	ARM64_MEMORY_DEVICE_GRE,
	ARM64_MEMORY_DEVICE_nGRE,
	ARM64_MEMORY_DEVICE_nGnRE,
	ARM64_MEMORY_DEVICE_nGnRnE,
};

struct arm64_memory_attr {
