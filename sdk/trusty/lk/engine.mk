...
LK_USE_GNU_TOOLCHAIN ?= $(if $(filter qemu-arm64,$(PROJECT)),true,false)

ifeq (true,$(call TOBOOL,$(LK_USE_GNU_TOOLCHAIN)))
GLOBAL_SHARED_COMPILEFLAGS := -g -include $(CONFIGHEADER)
GLOBAL_SHARED_COMPILEFLAGS += -Werror -Wall -Wsign-compare -Wno-multichar -Wno-unused-function -Wno-unused-label
GLOBAL_SHARED_COMPILEFLAGS += -Wno-attributes -Wno-return-type -Wno-maybe-uninitialized -Wno-missing-attributes
...
GLOBAL_SHARED_CPPFLAGS := -std=gnu++20 -fno-exceptions -fno-rtti -fno-threadsafe-statics
...
$(error GNU toolchain prefix not specified, please set ARCH_$(ARCH)_TOOLCHAIN_PREFIX)
endif
...
TOOLCHAIN_DEFINES := TOOLCHAIN_PREFIX=\"$(subst $(SPACE),_,$(TOOLCHAIN_PREFIX))\"
