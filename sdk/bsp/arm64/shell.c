...
struct shell_cmd arch_shell_cmds[] = {
	...
	{
		.str		= SHELL_CMD_HWTDBG,
		.cmd_param	= SHELL_CMD_HWTDBG_PARAM,
		.help_str	= SHELL_CMD_HWTDBG_HELP,
		.fcn		= shell_hwtdbg,
	},
	{
...
static int32_t shell_pmustat(int32_t argc, char **argv)
{
	...
	(void)snprintf(buffer, sizeof(buffer), "pmustat %s: %s (%d)\r\n",
